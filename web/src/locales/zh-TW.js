...
export default {
    ...
    exportUrlStats: '{folderCount} 個檔案夾，{fileCount} 個檔案，總大小 {totalDownloadSize}',
    aria2Download: '使用 Aria2 下載',
    aria2DownloadRecursive: '包含子檔案夾',
    aria2FetchingFiles: '正在獲取檔案，還剩 {remainingFolderCount} 個檔案夾待獲取',
    aria2DownloadStats: '將會下載 {folderCount} 個檔案夾中的 {fileCount} 個檔案，總計大小 {totalDownloadSize}',
