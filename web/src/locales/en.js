export default {
    ...
    exportUrlFetchingFiles: 'Fetching files, remaining {remainingFolderCount} folders',
    exportUrlFetchFileFailed: 'Fetch failed, reason: {reason}',
    exportUrlStats: '{fileCount} files in {folderCount} folders, total size: {totalDownloadSize}',
    aria2Download: 'Download with Aria2',
    aria2DownloadRecursive: 'Recursive download subfolders',
    aria2FetchingFiles: 'Fetching files, remaining {remainingFolderCount} folders',
    aria2DownloadStats: 'Will download {fileCount} files(in {folderCount} folders), {totalDownloadSize} in total',
    aria2DownloadProgress: 'Adding download tasks, remaining {remainingFileCount} files',
